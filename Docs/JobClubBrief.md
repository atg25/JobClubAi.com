...
Collect the following:
    ...
    Personal portfolio site (reference example:
    https://kaw393939.github.io/117_final_fall_2025/portfolio/ 
...
The site must reference or embed:
    ...
    A model student portfolio like the sample:
    https://kaw393939.github.io/117_final_fall_2025/portfolio/ 
...
Each team will present a 5-minute pitch covering:

    What Job Club is and why it matters

    UX & discovery process

    Live demo of onboarding workflow

    Events system

    Resource library

    Discord + CRM automation
    ...
    Why YOUR version should be the official Job Club site

9. Deployment Requirement

    Must deploy to GitHub Pages, Netlify, or Vercel

    Must deploy automatically through CI

    Must load analytics only after consent

    Must be fully accessible and mobile-friendly
